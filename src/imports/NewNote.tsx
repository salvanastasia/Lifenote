    ...
    <div className="backdrop-blur-[16px] bg-[rgba(255,255,255,0.8)] content-stretch flex flex-col gap-[58px] items-start overflow-clip px-[30px] py-[40px] relative rounded-[32px] w-[369px]">
      ...
      <div className="absolute flex h-[280.639px] items-center justify-center left-[29.66px] top-[85.85px] w-[309.579px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "38" } as React.CSSProperties}>
        <div className="flex-none rotate-[0.12deg]">
          <p className="font-['Figma_Hand:Regular',sans-serif] leading-[2.84] not-italic relative text-[14px] text-[rgba(90,74,53,0)] w-[309px] whitespace-pre-wrap">Woke up to the smell of lemons and the sound of the Tyrrhenian Sea. Explored the colorful streets of Positano, each corner a postcard. Ended the day with fresh pasta overlooking the coast. Sicily is pure magic.</p>
        </div>
      </div>
    </div>
  );
...
export default function NewNote() {
  return (
    <div className="bg-[#f2ede7] relative size-full" data-name="New Note">
      ...
      <div className="absolute flex h-[357.848px] items-center justify-center left-[32.61px] top-[181.08px] w-[329.774px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[-1.8deg]">
          <Frame />
        </div>
      </div>
      <div className="absolute flex h-[374.162px] items-center justify-center left-[23.62px] top-[172.92px] w-[347.765px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "753.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[4.94deg]">
          <Frame1 />
        </div>
      </div>
      <div className="-translate-x-1/2 absolute bottom-[-124.78px] flex h-[401.879px] items-center justify-center left-[calc(50%+0.41px)] w-[369.829px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "210.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[-0.12deg]">
          <Frame2 />
        </div>
      </div>
